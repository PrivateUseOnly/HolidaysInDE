...
open class CheckPrefix {
    ...
    fun checkPrefixZero(checkedZipcode: Int): String {
        ...
        return if (exceptionsCityCounter > 0) {
            "$zipcodeInLand: $land1, $butThereAreExceptions $exceptionsCityCounter exceptions: $exceptions $inLand: $land2"
        }else {
            land1
        }
    }
    fun checkPrefixOne(checkedZipcode: Int): String {
        when (checkedZipcode) {
            ...
            17285 -> {
                exceptionsCityCounter = 1
                land1 = "$mecklenburg, $brandenburg: Beenz"
            }
            17259 -> {
                land1 = mecklenburg
            }
            17268 -> {
                land1 = "$brandenburg, $mecklenburg: Tackmannshof"
            }
            in 17279..17291 -> {
                land1 = brandenburg
            }
            ...
            17337 -> {
                exceptionsCityCounter = 1
                land1 = "$mecklenburg, $brandenburg: Uckerland"
            }
            in 17348..19260 -> {
                land1 = mecklenburg
            }
            ...
            19357 -> {
                exceptionsCityCounter = 2
                land1 = "$brandenburg, $mecklenburg: Dambeck, Klüß"
            }
            in 19370..19417 -> {
                land1 = mecklenburg
            }
    ...
    fun checkPrefixTwo(checkedZipcode: Int): String {
        when (checkedZipcode) {
            ...
            21039 -> {
                exceptionsCityCounter = 1
                land1 = "$schleswig, $hamburg: $hamburg"
            }
            in 21073..21149 -> {
                land1 = hamburg
            }
            ...
            22113 -> {
                land1 = "$hamburg, $schleswig: Oststeinbek"
            }
            in 22115..22143 -> {
                land1 = hamburg
            }
    ...
    fun checkPrefixThree(checkedZipcode: Int): String {
        when (checkedZipcode) {
            ...
            34355 -> {
                exceptionsCityCounter = 1
                land1 = "$niedersachsen, $hessen: Kassel"
            }
            in 34359..34399 -> {
                land1 = hessen
            }
            ...
            37194 -> {
                exceptionsCityCounter = 1
                land1 = "$niedersachsen, $hessen: Wahlsburg"
            }
            in 37197..37199 -> {
                land1 = niedersachsen
            }
    ...
    fun checkPrefixFive(checkedZipcode: Int):String {
        when(checkedZipcode){
            50126 ->{land1 = rheinland}
            in 51643..53359 -> {land1 = nrw}
            in 53424..53579 -> {land1 = rheinland}
            53604 -> {land1 = nrw}
            53619 -> {land1 = rheinland}
            in 53639..53949 -> {land1 = nrw}
            in 54290..55239 -> {land1 = rheinland}
            in 55246..55252 -> {land1 = hessen}
            in 55257..56869 -> {land1 = rheinland}
            in 57072..57489 -> {land1 = nrw }
            in 57518..57648 -> {land1 = rheinland}
            in 58089..59964 -> {land1 = nrw}
            59969 -> {
                exceptionsCityCounter = 1
                land1 = "$nrw, $hessen: Bromskirchen"}
            else -> land1 = invalidZipcode
        }
    ...
    fun checkPrefixSix(chechedZipcode: Int):String {
        when(chechedZipcode) {
            ...
            63776 -> {
                exceptionsCityCounter = 1
                land1 = "$bayern, $hessen: Hüttelngesäß"
            }
            in 63785..63927 -> {
                land1 = bayern
            }
            63928 -> {
                exceptionsCityCounter = 1
                land1 = "$bayern, $baden: Spritzenmühle"
            }
            in 63930..63939 -> {
                land1 = bayern
            }
            ...
            64754 -> {
                exceptionsCityCounter = 1
                land1 = "$hessen, $baden: Badisch Schöllenbach"
            }
            in 64756..65321 -> {
                land1 = hessen
            }
            65326 -> {
                exceptionsCityCounter = 1
                land1 = "$hessen, $rheinland: Sandersmühle"
            }
            in 65329..65388 -> {
                land1 = hessen
            }
            65391 -> {
                exceptionsCityCounter = 1
                land1 = "$hessen, $rheinland: Sauerthal"
            }
            in 65396..65556 -> {
                land1 = hessen
            }
            ...
            69412 -> {
                exceptionsCityCounter = 1
                land1 = "$baden, $hessen: Igelsbach"
            }
            in 69427..69434 -> {land1 = baden}
            69434 -> {
                exceptionsCityCounter = 1
                land1 = "$baden, $hessen: Hirschhorn"}
            in 69436..69469 -> {land1 = baden}
            in 69483..69488 -> {land1 = hessen}
            in 69493..69514 -> {land1 = baden}
            in 69517..69518 -> {land1 = hessen}
            else -> {land1 = invalidZipcode}
        }
    ...
    fun checkPrefixSeven(checkedZipcode: Int): String {
        when(checkedZipcode) {
            ...
            74594 -> {
                exceptionsCityCounter = 1
                land1 = "$baden, $bayern: Gumpenweiler"
            }
            in 74595..76709 -> {
                land1 = baden
            }
    ...
    fun checkPrefixNine(checkedZipcode: Int): String {
        when(checkedZipcode) {
            ...
            97900 -> {land1 = baden}
            in 97901..97909 -> {land1 = bayern}
            in 97922..97999 -> {land1 = baden}
            in 98527..99998 -> {land1 = thueringen}
            else -> land1 = invalidZipcode
        }
